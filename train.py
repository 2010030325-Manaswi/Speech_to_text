...
def main(args):
    ...
    trainer = Trainer(
        max_epochs=args.epochs, accelerator='cuda',
...
if __name__ == "__main__":
    ...
    parser.add_argument('-n', '--nodes', default=2, type=int, help='number of data loading workers')
    parser.add_argument('-g', '--gpus', default=100, type=int, help='number of gpus per node')
    parser.add_argument('-w', '--data_workers', default=15, type=int,
    ...
    # train and valid
    parser.add_argument('--train_file', default='train.json', required=False, type=str,
                        help='json file to load training data')
    parser.add_argument('--valid_file', default='test.json', required=False, type=str,
    ...
    parser.add_argument('--save_model_path', default='E:\\Sainikudu', required=False, type=str,

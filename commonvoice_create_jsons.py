...
def main(args):
    ...
    with open(args.save_json_path +"/"+ 'train.json','w',encoding='utf-8') as f:
        d = len(data)
        i=0
    ...
    with open(args.save_json_path +"/"+ 'test.json','w',encoding='utf-8') as f:
        d = len(data)
        i=int(d-d/percent)
        while(i<d):
            r=data[i]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--file_path', type=str, default='en/other.tsv', required=False,
